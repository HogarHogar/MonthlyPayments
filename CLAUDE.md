...
| `👟👟CHECKLIST_RUNNING👟👟` | A mandatory checklist is executing | Before the checklist name, during work |
...
| `📝📝SUMMARY_OF_CHANGES📝📝` | Changes were made in the response | Last section before CODING_COMPLETE (skip if purely informational) |
...
- This applies to inline commentary during work, SUMMARY_OF_CHANGES bullets, and any other output where a subagent's contribution is being relayed
