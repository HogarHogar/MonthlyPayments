...
| `⏳⏳ESTIMATE ≈ Xm⏳⏳` | Next phase estimated >2 min | Immediately before the phase's bookend marker | — | — |
...
**Normal flow (with time estimate):**
```
