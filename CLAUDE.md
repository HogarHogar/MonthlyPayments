...
5. **README title** — replace the `# Auto Update HTML Template` heading at the top of `README.md` with `# ReadMe - YOUR_REPO_NAME` (resolved value, preserving any invisible characters before the title text). Update `YOUR_PROJECT_TITLE` in the Template Variables table to match
